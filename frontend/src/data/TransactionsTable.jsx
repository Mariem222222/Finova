...
export default function TransactionsTable({ budgets = [] }) {
                  ...
                  >
                    ...
                    <td className="p-3">
                      {tx.type === 'expense' && (
                        <div className="flex items-center">
                          {(() => {
                            const status = getBudgetStatus(tx.category);
